package com.dragonblocks.util.stairs;

import net.minecraft.util.EnumFacing;
import net.minecraft.world.World;
import com.dragonblocks.data.Stairs;
import com.dragonblocks.data.Stairs.Type;
import com.dragonblocks.objects.blocks.BlockStairs;
...
public class StairsTransform {
    ...
    public static int transformStairs(TEBase TE, int stairsID, int x, int y, int z)
    {
        ...
        Stairs stairs_XN = world.getBlock(x - 1, y, z) instanceof BlockStairs ? Stairs.stairsList[((TEBase) world.getTileEntity(x - 1, y, z)).getData()] : null;
        Stairs stairs_XP = world.getBlock(x + 1, y, z) instanceof BlockStairs ? Stairs.stairsList[((TEBase) world.getTileEntity(x + 1, y, z)).getData()] : null;
        Stairs stairs_YN = world.getBlock(x, y - 1, z) instanceof BlockStairs ? Stairs.stairsList[((TEBase) world.getTileEntity(x, y - 1, z)).getData()] : null;
        Stairs stairs_YP = world.getBlock(x, y + 1, z) instanceof BlockStairs ? Stairs.stairsList[((TEBase) world.getTileEntity(x, y + 1, z)).getData()] : null;
        Stairs stairs_ZN = world.getBlock(x, y, z - 1) instanceof BlockStairs ? Stairs.stairsList[((TEBase) world.getTileEntity(x, y, z - 1)).getData()] : null;
        Stairs stairs_ZP = world.getBlock(x, y, z + 1) instanceof BlockStairs ? Stairs.stairsList[((TEBase) world.getTileEntity(x, y, z + 1)).getData()] : null;
