...
import com.dragonblocks.data.Slope.Face;
...
public class SlopeTransform {
    ...
    {
        Slope slope_XN = world.getBlock(x - 1, y, z) instanceof BlockSlope ? Slope.getSlope(((TEBase) world.getTileEntity(x - 1, y, z))) : null;
        Slope slope_XP = world.getBlock(x + 1, y, z) instanceof BlockSlope ? Slope.getSlope(((TEBase) world.getTileEntity(x + 1, y, z))) : null;
        Slope slope_YN = world.getBlock(x, y - 1, z) instanceof BlockSlope ? Slope.getSlope(((TEBase) world.getTileEntity(x, y - 1, z))) : null;
        Slope slope_YP = world.getBlock(x, y + 1, z) instanceof BlockSlope ? Slope.getSlope(((TEBase) world.getTileEntity(x, y + 1, z))) : null;
        Slope slope_ZN = world.getBlock(x, y, z - 1) instanceof BlockSlope ? Slope.getSlope(((TEBase) world.getTileEntity(x, y, z - 1))) : null;
        Slope slope_ZP = world.getBlock(x, y, z + 1) instanceof BlockSlope ? Slope.getSlope(((TEBase) world.getTileEntity(x, y, z + 1))) : null;
