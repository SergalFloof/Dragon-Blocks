...
public class BlockProperties {
    ...
    public final static SoundType stepSound = new SoundType(Reference.MODID, 1.0F, 1.0F);
    ...
    public static void playBlockSound(World world, ItemStack itemStack, int x, int y, int z, boolean reducedVolume)
    {
        if (itemStack != null) {
            ...
            world.playSound(x + 0.5F, y + 0.5F, z + 0.5F, soundType.ANVIL, volume, pitch);
    ...
    public static ItemStack getCallableItemStack(ItemStack itemStack)
    {
        ...
        if (block instanceof BlockCoverable || block instanceof IWrappableBlock) {
            ...
            return block.hasTileEntity() ? new ItemStack(Blocks.PLANKS) : itemStack;
        }
    }
     ...
     * @return
     */
    public static ItemStack getFeatureSensitiveSideItemStack(TEBase TE, EnumFacing side)
    {
        if (side.equals(EnumFacing.UNKNOWN)) {
