...
//            RenderingRegistry.registerBlockHandler(carpentersBlockRenderID, new BlockHandlerBlock());
//
//            if (enableBarrier) {
//                carpentersBarrierRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersBarrierRenderID, new BlockHandlerBarrier());
//            }
//            if (enableButton) {
//                carpentersButtonRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersButtonRenderID, new BlockHandlerButton());
//            }
...
//                RenderingRegistry.registerBlockHandler(carpentersGateRenderID, new BlockHandlerGate());
//            }
//            if (enableLever) {
//                carpentersLeverRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersLeverRenderID, new BlockHandlerLever());
//            }
//            if (enablePressurePlate) {
//                carpentersPressurePlateRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersPressurePlateRenderID, new BlockHandlerPressurePlate());
//            }
//            if (enableSlope) {
//                carpentersSlopeRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersSlopeRenderID, new BlockHandlerSlope());
//            }
//            if (enableStairs) {
//                carpentersStairsRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersStairsRenderID, new BlockHandlerStairs());
//            }
//            if (enableHatch) {
//                carpentersHatchRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersHatchRenderID, new BlockHandlerHatch());
//            }
//            if (enableDoor) {
//                carpentersDoorRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersDoorRenderID, new BlockHandlerDoor());
//            }
//            if (enableBed) {
//                carpentersBedRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersBedRenderID, new BlockHandlerBed());
//            }
//            if (enableLadder) {
//                carpentersLadderRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersLadderRenderID, new BlockHandlerLadder());
//            }
...
//                RenderingRegistry.registerBlockHandler(carpentersTorchRenderID, new BlockHandlerTorch());
//            }
//            if (enableSafe) {
//                carpentersSafeRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersSafeRenderID, new BlockHandlerSafe());
//            }
//            if (enableFlowerPot) {
//                carpentersFlowerPotRenderID = RenderingRegistry.getNextAvailableRenderId();
//                RenderingRegistry.registerBlockHandler(carpentersFlowerPotRenderID, new BlockHandlerFlowerPot());
//            }
//
//        }
//
...
//        /* Carpenter's Block is always enabled because recipes rely on it. */
//
//        blockCarpentersBlock = new BlockBlock(Material.wood)
...
//
//        if (enableBarrier) {
//            blockCarpentersBarrier = new BlockBarrier(Material.wood)
...
//
//        if (enableBed) {
//            blockCarpentersBed = new BlockBed(Material.wood)
...
//
//        if (enableButton) {
//            blockCarpentersButton = new BlockButton(Material.circuits)
...
//
//        if (enableDoor) {
//            blockCarpentersDoor = new BlockDoor(Material.wood)
...
//
//        if (enableFlowerPot) {
//            blockCarpentersFlowerPot = new BlockFlowerPot(Material.circuits)
...
//
//        if (enableGate) {
//            blockCarpentersGate = new BlockGate(Material.wood)
...
//
//        if (enableHatch) {
//            blockCarpentersHatch = new BlockHatch(Material.wood)
...
//
//        if (enableLadder) {
//            blockCarpentersLadder = new BlockLadder(Material.wood)
...
//
//        if (enableLever) {
//            blockCarpentersLever = new BlockLever(Material.circuits)
...
//
//        if (enablePressurePlate) {
//            blockCarpentersPressurePlate = new BlockPressurePlate(Material.circuits)
...
//
//        if (enableSafe) {
//            blockCarpentersSafe = new BlockSafe(Material.wood)
...
//
//        if (enableSlope) {
//            blockCarpentersSlope = new BlockSlope(Material.wood)
//                .setBlockName("blockCarpentersSlope")
//                .setHardness(0.2F)
//                .setStepSound(BlockProperties.stepSound)
//                .setCreativeTab(CarpentersBlocks.creativeTab);
//            GameRegistry.registerBlock(blockCarpentersSlope, ItemBlockSlope.class, "blockCarpentersSlope");
//            Blocks.fire.setFireInfo(blockCarpentersSlope, 5, 20);
//        }
//
//        if (enableStairs) {
//            blockCarpentersStairs = new BlockStairs(Material.wood)
...
//
//        if (enableTorch) {
//            blockCarpentersTorch = new BlockTorch(Material.circuits)
