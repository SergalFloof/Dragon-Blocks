...
import com.dragonblocks.objects.blocks.BlockBarrier;
import com.dragonblocks.tileentity.TEBase;
import com.dragonblocks.util.registry.BlockRegistry;

@SideOnly(Side.CLIENT)
public class BlockHandlerBarrier extends BlockHandlerBase {
    ...
    {
        BlockBarrier tempBlock = (BlockBarrier) srcBlock;
     ...
     */
    private void renderSupportPlank(ItemStack itemStack, int x, int y, int z, EnumFacing dir, double depthRadius, double yMin, double yMax, boolean enforce)
    {
