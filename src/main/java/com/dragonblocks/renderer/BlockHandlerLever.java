...
import com.dragonblocks.block.BlockCarpentersLever;
import com.dragonblocks.block.BlockCoverable;
import com.dragonblocks.data.Lever;
import com.dragonblocks.data.Lever.Axis;
...
public class BlockHandlerLever extends BlockHandlerBase {
    ...
    private void renderLever(ItemStack itemStack, int x, int y, int z)
    {
        ...
        BlockLever blockRef = (BlockLever) BlockRegistry.blockCarpentersLever;
