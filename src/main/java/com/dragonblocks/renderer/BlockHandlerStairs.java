...
import com.dragonblocks.block.BlockCarpentersStairs;
...
public class BlockHandlerStairs extends BlockHandlerBase {
    ...
    protected void renderCarpentersBlock(int x, int y, int z)
    {
        ...
        BlockStairs blockRef = (BlockStairs) BlockRegistry.blockCarpentersStairs;
