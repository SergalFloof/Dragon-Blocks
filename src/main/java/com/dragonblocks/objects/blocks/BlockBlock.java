...
import com.dragonblocks.data.Slab;
...
public class BlockBlock extends BlockSided {
    ...
    private boolean onHammerInteraction(TEBase TE)
    {
        if (data.isFullCube(TE)) {
            EnumFacing side = EnumFacing.getOrientation(EventHandler.eventFace).getOpposite();
    ...
    {
    	TEBase TE = createNewTileEntity(world, pos);
...
//    {
//        return BlockRegistry.blockRenderID;
//    }
