...
public class BlockSafe extends BlockCoverable {
    ...
    public BlockSafe(Material material)
    {
        super(material);
    }
    ...
    protected void postOnBlockActivated(TEBase TE, EntityPlayer entityPlayer, int side, float hitX, float hitY, float hitZ, ActionResult actionResult)
    {
        ...
        if (!Safe.isOpen(TE) && canPlayerActivate(TE, entityPlayer)) {
            ...
            if (!actionResult.decInv) {
                ...
                entityPlayer.displayGUIChest((TESafe)TE);
            }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if (TE != null && TE instanceof TESafe) {
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int metadata)
    {
        ...
        if (tileEntity != null && tileEntity instanceof TESafe)
        {
            TESafe TE = (TESafe) tileEntity;
