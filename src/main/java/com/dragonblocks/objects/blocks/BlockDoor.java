...
public class BlockDoor extends BlockHinged {
...
//    {
//        IconRegistry.icon_door_screen_tall         = iconRegister.registerIcon(Blocks.MODID + ":" + "door/door_screen_tall"        );
//        IconRegistry.icon_door_glass_tall_top      = iconRegister.registerIcon(Blocks.MODID + ":" + "door/door_glass_tall_top"     );
//        IconRegistry.icon_door_glass_tall_bottom   = iconRegister.registerIcon(Blocks.MODID + ":" + "door/door_glass_tall_bottom"  );
//        IconRegistry.icon_door_glass_top           = iconRegister.registerIcon(Blocks.MODID + ":" + "door/door_glass_top"          );
//        IconRegistry.icon_door_french_glass_top    = iconRegister.registerIcon(Blocks.MODID + ":" + "door/door_french_glass_top"   );
//        IconRegistry.icon_door_french_glass_bottom = iconRegister.registerIcon(Blocks.MODID + ":" + "door/door_french_glass_bottom");
//    }
