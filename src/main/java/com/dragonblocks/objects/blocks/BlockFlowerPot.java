...
import com.dragonblocks.data.FlowerPot;
import com.dragonblocks.network.PacketEnrichPlant;
import com.dragonblocks.tileentity.TEBase;
import com.dragonblocks.tileentity.TEFlowerPot;
import com.dragonblocks.util.BlockProperties;
import com.dragonblocks.util.flowerpot.FlowerPotHandler;
import com.dragonblocks.util.flowerpot.FlowerPotHandler.Profile;
import com.dragonblocks.util.flowerpot.FlowerPotProperties;
...
public class BlockFlowerPot extends BlockCoverable {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess blockAccess, int x, int y, int z)
    {
        ...
        if (TE != null && TE instanceof TEFlowerPot) {
