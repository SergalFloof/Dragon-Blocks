...
import com.dragonblocks.data.Barrier;
import com.dragonblocks.data.Gate;
import com.dragonblocks.tileentity.TEBase;
import com.dragonblocks.util.registry.BlockRegistry;

public class BlockBarrier extends BlockCoverable {
        ...
        if (TE != null) {
            ...
            for (TEBase TE_current : TE_list) {
                ...
                if (TE_current != null) {
                    ...
                    } else if (block.equals(BlockRegistry.blockGate)) {
    ...
    {
        boolean connect_ZN = canConnectBarrierTo(world, x, y, z - 1, EnumFacing.SOUTH);
        boolean connect_ZP = canConnectBarrierTo(world, x, y, z + 1, EnumFacing.NORTH);
        boolean connect_XN = canConnectBarrierTo(world, x - 1, y, z, EnumFacing.EAST);
        boolean connect_XP = canConnectBarrierTo(world, x + 1, y, z, EnumFacing.WEST);
        ...
        if (connect_ZN || connect_ZP)
        {
            ...
            super.addCollisionBoxToList(world, x, y, z, axisAlignedBB, list, entity);
        }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess blockAccess, int x, int y, int z)
    {
        ...
        {        
            ...
            boolean connect_ZN = canConnectBarrierTo(blockAccess, x, y, z - 1, EnumFacing.SOUTH);
            boolean connect_ZP = canConnectBarrierTo(blockAccess, x, y, z + 1, EnumFacing.NORTH);
            boolean connect_XN = canConnectBarrierTo(blockAccess, x - 1, y, z, EnumFacing.EAST);
            boolean connect_XP = canConnectBarrierTo(blockAccess, x + 1, y, z, EnumFacing.WEST);
     ...
     */
    public boolean canConnectBarrierTo(IBlockAccess blockAccess, int x, int y, int z, EnumFacing side)
    {
        Block block = blockAccess.getBlock(x, y, z);

        if (block.equals(this) || block.equals(BlockRegistry.blockGate)) {
            return true;
        } else {
    ...
    public EnumBlockRenderType getRenderType(IBlockState state) {
    	return BlockRegistry.BarrierRenderID;
    }
